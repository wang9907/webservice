 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.wang.com/", wsdlLocation = "file:/C:/Users/Administrator/git/webservice/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.wang.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Administrator/git/webservice/wsdl/HelloService.wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.wang.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.wang.com/", "HelloPort"), Hello.class, features);
    }
