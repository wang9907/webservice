 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.wang.com/", wsdlLocation = "http://localhost:8080/JaxwsProject/HelloService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/JaxwsProject/HelloService?wsdl");
